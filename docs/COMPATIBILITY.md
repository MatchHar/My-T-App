...
| My T Companion | public release `1.10.0` | Optional long-term bounded parking events/history, verified drive trajectories, remote charging/navigation Live Activities, software notifications, localized update notes, and supported state backup/restore (push/Live Activities need pairing) |
