...
| My T Companion | public release `1.8.0` | Adds optional parking history, verified drive trajectories, remote charging/navigation Live Activities, and software notifications |
