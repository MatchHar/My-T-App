...
| My T Companion | public release `1.9.2` | Adds optional retained parking events/history, verified drive trajectories, remote charging/navigation Live Activities, and software notifications |
