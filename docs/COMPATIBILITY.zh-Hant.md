...
| 元件 | 已驗證狀態 | 說明 |
| --- | --- | --- |
| My T | [App Store 目前公開版本](https://apps.apple.com/app/id6780299502)，iPhone、iOS 18+ | [自動產生的發行記錄](app-store-release.json)會跟隨 Apple 的公開資訊更新。Apple 正式發布前，開發中的功能仍屬預先發行內容。iPad 並非已承諾支援的目標。 |
