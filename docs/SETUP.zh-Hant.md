...
> **VPS 引導部署：** [HostBox 已於 App Store 上線](https://apps.apple.com/app/id6798103086)，可直接在 iPhone 安裝 My T Server 堆疊，並把測試過的一組 `base_url` + Token 交給 My T。詳情與上線影片請見 [HostBox 產品頁](https://my-tesla.app/hostbox/zh-hant/)；下方手動部署方式繼續受支援。
...
- 不複製完整車輛歷史，但預設會在 VPS 自有資料卷長期保存小型停車事件紀錄，
  並以最新 50,000 筆作為容量保護；
