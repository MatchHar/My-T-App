...
forbidden_pattern='(^|/)(MyCarMate|AppStore|ci_scripts|DerivedData|secrets|private)(/|$)|\.(swift|pbxproj|ipa|mobileprovision|p12|cer|key|pem|log|dump|sql)$|\.xcodeproj/|\.xcworkspace/|(^|/)\.env(\.|$)|(^|/)GoogleService-Info\.plist$|(^|/)ExportOptions[^/]*\.plist$'
