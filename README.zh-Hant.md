...
> **功能可用性：**App Store 目前提供 My T 3.10。本頁所述的停車監控
> 整合正在為後續 My T 版本準備，尚未包含於公開的 App Store 版本。詳情請參閱
...
是選裝伺服器元件，用於真實的長期停車休眠／喚醒歷史、電量／續航觀測、之後
真實發生的插槍／充電、保全／開關、空調及充電埠事件、可靠的目前行駛軌跡，
以及 App 未開啟時的充電鎖定畫面即時動態更新。未安裝時，My T 基礎功能仍可
正常使用。
